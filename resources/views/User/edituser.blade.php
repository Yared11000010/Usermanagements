                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror"
                         name="usertype" value={{ $users->usertype }} >
                          <option>Admin</option>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="email" value="{{ $users->email }}" class="form-control border @error('email') is invalid
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="password" value="{{ $users->password }}" class="form-control border @error('password') is invalid
